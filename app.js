...
var _esad$blockade$Direction$toVector = function (d) {
	var _p0 = d;
	switch (_p0.ctor) {
		case 'N':
...
var _esad$blockade$Direction$None = {ctor: 'None'};
var _esad$blockade$Direction$U = {ctor: 'U'};
var _esad$blockade$Direction$CCW = {ctor: 'CCW'};
var _esad$blockade$Direction$CW = {ctor: 'CW'};
var _esad$blockade$Direction$randomTurn = A2(
	_elm_lang$core$Random$map,
	_elm_lang$core$Maybe$withDefault(_esad$blockade$Direction$None),
	_elm_community$random_extra$Random_Extra$sample(
		_elm_lang$core$Native_List.fromArray(
			[_esad$blockade$Direction$CW, _esad$blockade$Direction$CCW, _esad$blockade$Direction$U, _esad$blockade$Direction$None])));
var _esad$blockade$Direction$E = {ctor: 'E'};
var _esad$blockade$Direction$W = {ctor: 'W'};
var _esad$blockade$Direction$S = {ctor: 'S'};
var _esad$blockade$Direction$N = {ctor: 'N'};
var _esad$blockade$Direction$random = A2(
	_elm_lang$core$Random$map,
	_elm_lang$core$Maybe$withDefault(_esad$blockade$Direction$N),
	_elm_community$random_extra$Random_Extra$sample(
		_elm_lang$core$Native_List.fromArray(
			[_esad$blockade$Direction$N, _esad$blockade$Direction$S, _esad$blockade$Direction$W, _esad$blockade$Direction$E])));
var _esad$blockade$Direction$turn = F2(
	function (d, t) {
		var _p1 = t;
		switch (_p1.ctor) {
			case 'None':
			...
			case 'U':
				...
				switch (_p2.ctor) {
					case 'N':
						return _esad$blockade$Direction$S;
					case 'S':
						return _esad$blockade$Direction$N;
					case 'E':
						return _esad$blockade$Direction$W;
					default:
						return _esad$blockade$Direction$E;
				}
			case 'CW':
				var _p3 = d;
				switch (_p3.ctor) {
...
var _esad$blockade$Ruleset$transition = F3(
	function (state, color, ruleset) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '_Tuple3', _0: state, _1: color, _2: _esad$blockade$Direction$None},
			A2(_elm_lang$core$Array$get, (color * ruleset.nStates) + state, ruleset.transitions));
	});
var _esad$blockade$Ruleset$random = F2(
	function (nStates, nColors) {
		return A2(
			_elm_lang$core$Random$map,
			function (ts) {
				return {
					nStates: nStates,
					transitions: _elm_lang$core$Array$fromList(ts)
				};
			},
			A2(
				...
				A4(
					...
					A2(_elm_lang$core$Random$int, 0, nStates - 1),
					A2(_elm_lang$core$Random$int, 0, nColors - 1),
					_esad$blockade$Direction$randomTurn)));
	});
var _esad$blockade$Ruleset$Ruleset = F2(
	function (a, b) {
		return {nStates: a, transitions: b};
	});

var _esad$blockade$Turmite$toList = function (t) {
	var groupsOf = F2(
		function (n, xs) {
			var _p0 = xs;
			if (_p0.ctor === '[]') {
	...
	return A2(
		groupsOf,
		t.w,
		_elm_lang$core$Array$toList(t.canvas));
};
var _esad$blockade$Turmite$step = function (t) {
	var currentCanvasIndex = function (t) {
		return (t.y * t.w) + t.x;
	};
	var currentColor = function (t) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(
	...
	var _p1 = A3(
		_esad$blockade$Ruleset$transition,
		t.state,
		currentColor(t),
		t.ruleset);
	var state = _p1._0;
	var color = _p1._1;
	var turn = _p1._2;
	var direction = A2(_esad$blockade$Direction$turn, t.direction, turn);
	var _p2 = _esad$blockade$Direction$toVector(direction);
	var dx = _p2._0;
	var dy = _p2._1;
	return _elm_lang$core$Native_Utils.update(
		t,
		{
			direction: direction,
			state: state,
			x: A2(_elm_lang$core$Basics_ops['%'], t.x + dx, t.w),
			y: A2(_elm_lang$core$Basics_ops['%'], t.y + dy, t.h),
			canvas: A3(
...
var _esad$blockade$Turmite$boring = function (t) {
	var iterate = F3(
		function (f, x, n) {
			iterate:
			while (true) {
	...
	var t$ = A3(iterate, _esad$blockade$Turmite$step, t, 9);
	var t$$ = _esad$blockade$Turmite$step(t$);
	return _elm_lang$core$Native_Utils.eq(
		_esad$blockade$Turmite$toList(t$),
		_esad$blockade$Turmite$toList(t$$));
};
var _esad$blockade$Turmite$random = F4(
	function (w, h, nStates, nColors) {
		return A2(
			_elm_community$random_extra$Random_Extra$filter,
			function (_p3) {
				return _elm_lang$core$Basics$not(
					_esad$blockade$Turmite$boring(_p3));
			},
			A4(
				_elm_lang$core$Random$map3,
				F3(
					function (d, s, r) {
						return {
							...
							direction: d,
							ruleset: r,
							canvas: A2(_elm_lang$core$Array$repeat, w * h, 0)
						};
					}),
				_esad$blockade$Direction$random,
				A2(_elm_lang$core$Random$int, 0, nStates - 1),
				A2(_esad$blockade$Ruleset$random, nStates, nColors)));
	});
var _esad$blockade$Turmite$Turmite = F8(
	function (a, b, c, d, e, f, g, h) {
		return {x: a, y: b, w: c, h: d, state: e, direction: f, ruleset: g, canvas: h};
	});

var _esad$blockade$App$view = function (model) {
	var cell = function (c) {
		return A2(
	...
	var row = function (r) {
		return A2(
			...
			A2(_elm_lang$core$List$map, cell, r));
	};
	var colors = A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$Maybe$map, _esad$blockade$Turmite$toList, model.turmite));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('turmite')
			]),
		A2(_elm_lang$core$List$map, row, colors));
};
var _esad$blockade$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Init') {
			var _p2 = _p0._0;
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						turmite: A2(_elm_lang$core$Maybe$map, _esad$blockade$Turmite$step, model.turmite)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _esad$blockade$App$blockSize = 10;
var _esad$blockade$App$Model = function (a) {
	return {turmite: a};
};
var _esad$blockade$App$Flags = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _esad$blockade$App$Init = function (a) {
	return {ctor: 'Init', _0: a};
};
var _esad$blockade$App$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {turmite: _elm_lang$core$Maybe$Nothing},
		_1: A2(
			_elm_lang$core$Random$generate,
			_esad$blockade$App$Init,
			A4(_esad$blockade$Turmite$random, (flags.width / _esad$blockade$App$blockSize) | 0, (flags.height / _esad$blockade$App$blockSize) | 0, 8, 2))
	};
};
var _esad$blockade$App$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _esad$blockade$App$subs = function (model) {
	return A2(_elm_lang$core$Time$every, 20 * _elm_lang$core$Time$millisecond, _esad$blockade$App$Tick);
};
var _esad$blockade$App$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _esad$blockade$App$init, view: _esad$blockade$App$view, update: _esad$blockade$App$update, subscriptions: _esad$blockade$App$subs}),
	flags: A2(
...
var Elm = {};
Elm['App'] = Elm['App'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['App'], 'App', typeof _esad$blockade$App$main === 'undefined' ? null : _esad$blockade$App$main);
